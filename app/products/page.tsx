...
const categories: Category[] = [
  {
    ...
    items: [
      { code: "US-01", name: "Exposed Urinal Sensor", image: "/img/products/us01_converted.webp" },
      { code: "US-02", name: "Exposed Urinal Sensor", image: "/img/products/us02_converted.webp" },
      { code: "US-03", name: "4x4 Urinal Sensor", image: "/img/products/us03_converted.webp" },
      { code: "US-04", name: "Exposed Urinal Sensor", image: "/img/products/us04_converted.webp" },
      { code: "US-05", name: "Urinal Sensor Kit", image: "/img/products/us05_converted.webp" },
      { code: "US-06", name: "Urinal Sensor Kit", image: "/img/products/us06_converted.webp" },
      { code: "US-07", name: "Urinal Sensor Kit", image: "/img/products/us07_converted.webp" },
      { code: "US-08", name: "Urinal Sensor Kit", image: "/img/products/us08_converted.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "UE-01", name: "Sensor Eye", image: "/img/products/ue01_converted.webp" },
      { code: "UE-02", name: "Sensor Eye", image: "/img/products/ue02_converted.webp" },
      { code: "UE-03", name: "Sensor Eye", image: "/img/products/ue03_converted.webp" },
      { code: "UE-04", name: "Sensor Eye", image: "/img/products/ue04_converted.webp" },
      { code: "UE-05", name: "Sensor Eye", image: "/img/products/ue05_converted.webp" },
      { code: "UE-06", name: "Sensor Eye", image: "/img/products/ue06_converted.webp" },
      { code: "UE-07", name: "Sensor Eye", image: "/img/products/ue07_converted.webp" },
      { code: "UE-08", name: "Sensor Eye", image: "/img/products/ue08_converted.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "USV-01", name: "Water Flow Valve", image: "/img/products/usv01_converted.webp" },
      { code: "USV-02", name: "Brass Valve" ,image: "/img/products/usv02_converted.webp"},
      { code: "USV-03", name: "Black Valve L-Type", image: "/img/products/usv03_converted.webp" },
      { code: "USV-04", name: "Valve L-Type", image: "/img/products/usv04_converted.webp" },
      { code: "USV-07", name: "Black Valve Straight", image: "/img/products/usv07_converted.webp" },
      { code: "", name: "Water Flow Adjuster", image: "/img/products/waterFlowAdjuster_converted.webp" },
  ...
  },
  {
    ...
    items: [
      { code: "HD-01", name: "High Speed SS", image: "/img/products/hd01_converted.webp" },
      { code: "HD-02", name: "Nozzle Dryer", image: "/img/products/hd02_converted.webp" },
      { code: "HD-03", name: "ABS Dryer", image: "/img/products/hd03_converted.webp" },
      { code: "HD-04", name: "Jet Dryer", image: "/img/products/hd04_converted.webp" },
      { code: "HD-05", name: "ABS Dryer", image: "/img/products/hd05_converted.webp" },
      { code: "HD-06", name: "High Speed SS", image: "/img/products/hd06_converted.webp" },
      { code: "HD-07", name: "High Speed SS", image: "/img/products/hd07_converted.webp" },
      { code: "HD-08", name: "Jet Dryer", image: "/img/products/hd08_converted.webp" },
      { code: "HD-09", name: "High Speed SS", image: "/img/products/hd09_converted.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "HDS-01", name: "Hand Dryer Circuit", image: "/img/products/hds01_converted.webp" },
      { code: "HDS-02", name: "Heating Element" , image: "/img/products/hds02_converted.webp"},
    ],
  },
  {
    ...
    items: [
      { code: "SF-01", name: "Sensor Tap", image: "/img/products/sf01_converted.webp" },
      { code: "SF-02", name: "Deck Mount", image: "/img/products/sf02_converted.webp" },
      { code: "SF-03", name: "Wall Mount", image: "/img/products/sf03_converted.webp" },
      { code: "SF-04", name: "Deck Mount", image: "/img/products/sf04_converted.webp" },
      { code: "SF-05", name: "Deck Mount", image: "/img/products/sf05_converted.webp" },
      { code: "SF-06", name: "Swan Neck", image: "/img/products/sf06_converted.webp" },
      { code: "SF-07", name: "Wall Mount", image: "/img/products/sf07_converted.webp" },
      { code: "SF-08", name: "Semi Swan", image: "/img/products/sf08_converted.webp" },
      { code: "SF-09", name: "Long Neck", image: "/img/products/sf09_converted.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "SFS-01", name: "IR Eye", image: "/img/products/sfs01_converted.webp" },
      { code: "SFS-02", name: "IR Eye" , image: "/img/products/sfs02_converted.webp"},
      { code: "SFS-03", name: "Control Box", image: "/img/products/sfs03_converted.webp" },
      { code: "SFS-04", name: "Hot/Cold NRV", image: "/img/products/sfs04_converted.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "SD-01", name: "SS 304", image: "/img/products/sd01_converted.webp" },
      { code: "SD-02", name: "SS 304", image: "/img/products/sd02_converted.webp" },
      { code: "SD-03", name: "SS 304", image: "/img/products/sd03_converted.webp" },
      { code: "SD-04", name: "SS 304", image: "/img/products/sd04_converted.webp" },
      { code: "SD-05", name: "ABS", image: "/img/products/sd05_converted.webp" },
      { code: "SD-06", name: "ABS", image: "/img/products/sd06_converted.webp" },
      { code: "SD-07", name: "Double", image: "/img/products/sd07_converted.webp" },
      { code: "SD-08", name: "Double", image: "/img/products/sd08_converted.webp" },
      { code: "SD-09", name: "Triple", image: "/img/products/sd09_converted.webp" },
      { code: "SD-10", name: "ABS", image: "/img/products/sd10_converted.webp" },
      { code: "SD-11", name: "ABS", image: "/img/products/sd11_converted.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "ASD-01", name: "500ml", image: "/img/products/asd01.webp" },
      { code: "ASD-02", name: "Foam 300ml", image: "/img/products/asd02.webp" },
      { code: "ASD-03", name: "1000ml", image: "/img/products/asd03.webp" },
      { code: "ASD-04", name: "700ml", image: "/img/products/asd04.webp" },
      { code: "ASD-05", name: "SS 1000ml", image: "/img/products/asd05.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "SC-01", name: "Shoe Lamination Machine", image: "/img/products/sc01_converted.webp" },
      { code: "SC-02", name: "Shoe Cover Machine", image: "/img/products/sc02_converted.webp" },
      { code: "SC-03", name: "Shoe Shine Machine", image: "/img/products/sc03_converted.webp" },
      { code: "SC-04", name: "Shoe Shine Machine with Sole Cleaner", image: "/img/products/sc04_converted.webp" },
      { code: "SC-05", name: "ABS Shoe Cover Dispenser", image: "/img/products/sc05_converted.webp" },
      { code: "SC-06", name: "Aluminium Shoe Cover Dispenser", image: "/img/products/sc06_converted.webp" },
    ],
  },
  {
    ...
    items: [
      { code: "AD-01", name: "LED Perfume Dispenser", image: "/img/products/ad01.webp" },
      { code: "AD-02", name: "LED Perfume Dispenser with Remote", image: "/img/products/ad02.webp" },
    ],
  },
];
